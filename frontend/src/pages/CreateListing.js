...
const CreateListing = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await API.post('/accommodations', listingData);
    ...
    <div className="create-listing">
      <div className="container">
        <div className="page-header">
          ...
          <p>Add a new property to your Airbnb platform</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="listing-form">
          ...
          <div className="form-actions">
            <button type="button" className="btn btn-secondary" onClick={() => navigate('/admin/listings')} disabled={loading}>
              Cancel
            </button>
